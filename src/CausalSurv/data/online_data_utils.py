...
class ESMEOnlineDataModule(L.LightningDataModule):
    def __init__(self, 
                 data_dir: str, 
                 n_lines: int, 
                 n_intervals: int,
    ...
    def setup(self, stage: str | None = None):
        ...
        ESME_Dataset = ESMEOnlineDataset(X_list, X_static, P_list, P_static, d_list, time_list, event_list, self.n_lines, self.interval_bounds)
    ...
    def train_dataloader(self):
        return TorchData.DataLoader(self.train_dataset, batch_size=self.train_batch_size, shuffle=True, num_workers=1, persistent_workers=True)
...
if __name__ == "__main__":
    import time 
    data_module = ESMEOnlineDataModule(data_dir="../../../data/model_entry_imputed_data_HR+HER2-_stable_types_categorized.parquet",
                                 n_lines=2,
                                 n_intervals=10,
                                 train_batch_size=32,
                                 val_split=0.2,
