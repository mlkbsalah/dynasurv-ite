...
if __name__ == "__main__":
    ...
    auc_dict = main(
        ...
        split_seed=split_seed,
        lambda_ipm_emd2=[0, 0.01, 0.1, 1.0, 10.0, 100.0, 1000.0, 10000.0],
    )

    df = pd.DataFrame(auc_dict)
    df.to_csv("auc_results_ipm_emd2.csv")
